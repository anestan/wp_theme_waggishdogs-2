...
<div id="page" class="site min-h-screen flex flex-col">
	<a class="skip-link screen-reader-text sr-only" href="#primary"><?php esc_html_e( 'Skip to content', 'underscores_tailwind' ); ?></a>

	<header id="masthead" class="site-header">

	<div id="site-navigation" class="fixed bottom-0 right-0 md:bottom-auto md:top-0 mr-4 mt-5 mb-5">
	<button id="nav_button" style="width: 55px; height: 55px" class="bg-green-400  p-2 rounded-full shadow-lg"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 576 576" style="enable-background:new 0 0 576 576;" xml:space="preserve"><path style="fill:#fff" d="M151.841,240.182c21.674,49.02,12.437,100.609-20.632,115.23
    ...
    c-18.898,50.725,0.208,69.426,1.823,70.781C165.541,579.957,225.438,542.266,259.255,532.816z"></path></svg></button>

	<nav id="nav_menu" class="tw-apply-main-navigation hidden ">
		<?php
